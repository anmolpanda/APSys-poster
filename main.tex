...
\usepackage{mdframed} % for border arounf figures
%----------------------------------------------------------------------------------------
%	TITLE SECTION 
%----------------------------------------------------------------------------------------
...
% \begin{tiny}
% \begin{tabular}[b]{p{\onecolwid}}
% sub\hspace{0.2cm}{\bf app} \{\\
% \hspace{0.3cm}for (i = 0; i < B; i++)\\
% \hspace{0.6cm}p[i] = read\_from\_input\_NIC();\\
% \hspace{0.3cm}for (i = 0; i < B; i++)\\
% \hspace{0.6cm}p[i] = process\_packet(p[i]);\\
% \hspace{0.3cm}for (i = 0; i < B; i++)\\
...
\end{figure}
% % \begin{figure}[h!]
% % \fbox{\includegraphics[width=1\linewidth]{img/optimization_1}}
% % \caption{Figure caption}
% % \end{figure}
% % 
% % \begin{figure}[h!]
% % \fbox{\includegraphics[width=1\linewidth]{img/optimization_2}}
% % \caption{Figure caption}
% % \end{figure}
% % 
% % \begin{figure}[h!]
% % \fbox{\includegraphics[width=1\linewidth]{img/optimization_3}}
% % \caption{Figure caption}
% % \end{figure}
